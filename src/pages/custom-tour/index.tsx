          ...
          {tourData.map((tour) => (
            <View key={tour.id} className="tour-card">
              ...
              <View className="tour-image-container">
                <Image className="tour-image" src={tour.image} mode="aspectFill" lazyLoad />
                {/* 价格标签 */}
              ...
              <View className="tour-info">
                ...
                <View className="tour-actions">
                  <Button className="details-btn" onClick={() => handleViewDetails(tour)}>
                    查看详情
                  </Button>
                  <Button className="schedule-btn" onClick={() => handleViewSchedule(tour)}>
                    行程安排
                  </Button>
                  <Button className="book-btn" type="primary" onClick={() => handleBookNow(tour)}>
                    立即预订
                  </Button>
                </View>
              </View>
