      ...
      <ScrollView className='content' scrollY>
        ...
        <View className='basic-info-section'>
          ...
          <View className='location-info'>
            ...
            <Text className='suburb-text'>{house.suburb}, {house.state} {house.postcode}</Text>
          </View>
          ...
          <View className='config-info'>
            ...
            {house.landArea && (
              <Text className='area-text'>• 土地面积: {house.landArea}㎡</Text>
            )}
            ...
            <View className='costs-list'>
              {house.additionalCosts.map((cost, index) => (
                <View key={index} className='cost-item'>
                  ...
                  <Text className='cost-amount'>${cost.amount}/{cost.frequency === 'weekly' ? '周' : cost.frequency === 'monthly' ? '月' : cost.frequency}</Text>
                </View>
              ))}
            </View>
          </View>
