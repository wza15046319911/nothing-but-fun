      ...
      {stats && (
        <View className="stats-section">
          <View className="overall-rating">
            ...
            <Rate value={parseFloat(stats.averageRating)} readOnly={true} />
        ...
        <ScrollView className="reviews-list" scrollY>
          {loading ? (
            ...
            <View className="empty-container">
              <Empty description="暂无评价，快来写第一条评价吧！" imageSize={80} />
              <Button className="first-review-btn" type="primary" onClick={handleWriteReview}>
                撰写第一条评价
              </Button>
            </View>
          ) : (
                ...
                <View key={review.id} className="review-item">
                  <View className="review-header">
                    ...
                    <View className="rating-info">
                      <Rate value={review.rating} readOnly={true} />
                      <Text
