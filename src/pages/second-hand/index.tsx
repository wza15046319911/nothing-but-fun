        ...
        <View className='header-content'>
          <View className='title-section'>
            ...
            <View className='stats-section'>
              ...
              <View className='stat-item'>
                <Text className='stat-number'>{items.filter(item => item.status === 'available').length}</Text>
                ...
                >
                  ...
                  <View className='enhanced-item-image-container'>
                    ...
                    <View className='price-badge-floating'>
                      ...
                      <Text className='price-amount'>{item.price}</Text>
                    </View>
                  </View>
                  ...
                  <View className='enhanced-item-info'>
                    <View className='info-header'>
                      ...
                      <View className='item-meta'>
                        <Text className='meta-time'>{formatTime(item.createdAt)}</Text>
                      </View>
                    </View>
                    ...
                    <View className='info-footer'>
                      <View className='price-section'>
                        ...
                        <Text className='enhanced-item-price'>${item.price}</Text>
                      </View>
